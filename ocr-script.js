...
const RANGE = 'OCR Tracker!A1:H1000'; // Adjust the range and sheet name according to your new sheet tab
...
function renderTable(data) {
    ...
    for (let i = 1; i < data.length; i++) {
        ...
        row.forEach(cell => {
            ...
            if (cell.toLowerCase() === 'high') {
                td.style.color = 'red';
            } else if (cell.toLowerCase() === 'medium') {
                td.style.color = 'orange';
            } else if (cell.toLowerCase() === 'low') {
...
function downloadCSV(data) {
    ...
    link.setAttribute("download", "ocr_tracker_data.csv");
